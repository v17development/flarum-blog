...
var BlogItem = /*#__PURE__*/function (_Page) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      className: "Post-body"
    }, !this.loading && this.article.blogMeta() && this.article.blogMeta().isPendingReview() == true && m("blockquote", {
      "class": "uncited",
      style: {
        fontSize: '16px'
      }
...
var BlogOverview = /*#__PURE__*/function (_Page) {
  ...
  _proto.view = function view() {
    ...
    return m("div", {
      ...
      icon: "fas fa-pencil"
    }, app.translator.trans('v17development-flarum-blog.forum.compose.write_article')), this.title(), m("div", {
      style: {
        clear: 'both'
      }
    }), m("div", {
    ...
    }, app.translator.trans('v17development-flarum-blog.forum.no_more_posts'))), m("div", {
      className: "Sidebar"
  ...
  Object(flarum_extend__WEBPACK_IMPORTED_MODULE_3__["override"])(flarum_components_DiscussionPage__WEBPACK_IMPORTED_MODULE_1___default.a.prototype, 'view', function (original) {
    ...
    if (discussionRedirectEnabled && this.discussion && this.discussion && this.discussion.tags().length > 0) {
      ...
      if (foundTags.length > 0) {
        ...
        }, app.translator.trans('v17development-flarum-blog.forum.utils.redirect.title')), app.translator.trans('v17development-flarum-blog.forum.utils.redirect.link', {
          a: m("a", {
            href: url
          })
        }));
